...
async function getRemarkCwd(startDir) {
...
/* ·········································································· */
function pushErrors(errors, yamlDoc, vFile, 
...
lineCounter) {
    errors.forEach((error) => {
        ...
        if (error.message) {
            ...
            const errMessage = `${error.message.charAt(0).toUpperCase()}` +
...
/* ·········································································· */
async function validateFrontmatter(sourceYaml, vFile, settings) {
    const hasPropSchema = typeof settings.embed === 'object';
    const lineCounter = new LineCounter();
    let yamlDoc;
    let yamlJS;
    let hasLocalAssoc = false;
    let schemaPathFromCwd;
    ...
    if (yamlDoc && yamlJS && !hasLocalAssoc) {
        Object.entries(settings.schemas ?? {}).forEach(([globSchemaPath, globSchemaAssocs]) => {
    ...
    if (hasPropSchema) {
        ...
        schema = await $RefParser
            ...
            .then((refSchema) => refSchema ? refSchema : undefined);
    ...
    if (schema && yamlDoc) {
        ...
        try {
            ...
            if (validate.errors?.length) {
                pushErrors(validate.errors, yamlDoc, vFile, schemaPathFromCwd ?? '', lineCounter);
            }
        }
        catch (error) {
            if (error instanceof Error) {
